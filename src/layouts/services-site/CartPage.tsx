...
const CartPage = () => {
  ...
  const recommendedPackages = [
    { id: 1, packageName: 'Full Circuit Track Insurance', price: '+$100/day', desc: 'Zero-deductible coverage while driving on certified racing circuits.', img: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=600&q=80' },
    { id: 2, packageName: 'Pre-Paid Fuel Drop-off', price: '+$90 flat', desc: 'Return the car empty. We will handle the premium refueling.', img: 'https://images.unsplash.com/photo-1549419616-09a2b53c6e9d?auto=format&fit=crop&w=600&q=80' },
  ];
              ...
              <div key={item.id} className="bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-200 flex flex-col sm:flex-row">
                ...
                <div className="p-6 flex flex-col justify-between flex-1">
                  ...
                  <div className="mt-4 text-right">
                    ...
                    <span className="text-xl font-extrabold text-[#000814]">{item.price}</span>
                  </div>
                </div>
              </div>
            ))}
                ...
                {recommendedPackages.map((pkg) => (
                  <div key={pkg.id} className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                    <div className="p-5 flex flex-col h-full">
                      ...
                      <button className="bg-[#f4f4f5] hover:bg-[#001d3d] hover:text-white border border-gray-300 text-[#001d3d] font-bold py-2 rounded-lg text-sm transition-colors w-full">
                        + Add to Reservation
                      </button>
                    </div>
                  </div>
          ...
          <div className="flex-[1] bg-white rounded-2xl p-6 shadow-xl border-t-8 border-[#003566] w-full lg:sticky lg:top-28">
            ...
            <div className="space-y-4 text-sm font-medium text-gray-600 mb-6">
              <div className="flex justify-between">
                <span>Vehicle Base Rate (3 Days)</span> 
                <span className="text-[#000814]">$1,200.00</span>
              </div>
              <div className="flex justify-between">
                <span>Carbon Package Add-on</span> 
                <span className="text-[#000814]">$150.00</span>
              </div>
              <div className="flex justify-between border-b border-gray-200 pb-4">
                <span>Taxes & Fees (13%)</span> 
                <span className="text-[#000814]">$175.50</span>
              </div>
              <div className="flex justify-between items-center pt-2">
                <span className="text-lg font-bold text-[#001d3d]">Total</span> 
                <span className="text-2xl font-extrabold text-[#000814]">$1,525.50</span>
              </div>
            </div>
            
            <button className="bg-[#ffd60a] hover:bg-[#ffc300] text-[#000814] rounded-xl py-4 text-center text-lg font-extrabold transition-all shadow-md w-full uppercase tracking-wide">
              Complete Checkout
            </button>

...
const Footer = () => (
  <footer className="bg-[#000814] text-white p-10 md:p-12 mt-auto border-t-4 border-[#003566]">
    <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
      ...
      <div>
        <h4 className="text-white font-semibold mb-4 text-lg">Service Links</h4>
        <ul className="text-sm text-gray-400 space-y-2">
          <li><a href="#" className="hover:text-[#ffc300] transition-colors">Weekend Rentals (Oscar)</a></li>
          <li><a href="#" className="hover:text-[#ffc300] transition-colors">Track Inventory (Carlos)</a></li>
        ...
        <div className="relative z-10 max-w-5xl mx-auto w-full">
          ...
          <div className="bg-white p-4 md:p-6 rounded-2xl flex flex-col md:flex-row gap-4 items-center w-full shadow-2xl border-4 border-[#ffd60a]">
            <div className="flex-1 w-full">
              <label className="block text-xs font-bold text-[#003566] uppercase tracking-wider mb-1 px-2">Search Catalog</label>
              <input 
                type="text" 
            ...
            <div className="w-full md:w-48">
              <label className="block text-xs font-bold text-[#003566] uppercase tracking-wider mb-1 px-2">Make</label>
              <select 
                value={searchMake}
                onChange={(e) => setSearchMake(e.target.value)}
                className="w-full bg-[#f4f4f5] border border-gray-300 rounded-xl text-[#000814] px-4 py-3 outline-none focus:ring-2 focus:ring-[#003566] cursor-pointer"
              >
            ...
            <div className="w-full md:w-auto mt-auto">
              <button className="w-full md:w-auto bg-[#001d3d] hover:bg-[#003566] text-white font-bold rounded-xl px-8 py-3 shadow-md transition-colors h-[50px] active:scale-95">
                Search Fleet
              </button>
            </div>
          </div>
            ...
            <div key={car.id} className="bg-white rounded-2xl overflow-hidden flex flex-col shadow-xl border border-gray-200 hover:-translate-y-2 transition-transform group cursor-pointer">
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <div className="mt-auto pt-4 border-t border-gray-100 flex justify-between items-center">
                  ...
                  <a href="/promotions" className="text-[#003566] font-bold hover:text-[#ffc300] transition-colors">View Details →</a>
                </div>
              </div>
            </div>
          ))}

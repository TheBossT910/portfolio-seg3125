...
const SurveyContent = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-16">
      <div className="bg-white p-8 md:p-12 rounded-xl shadow-md border border-gray-200">
        {!submitted ? (
          <form onSubmit={handleSubmit} className="animate-fade-in">
            ...
            <div className="mb-10 bg-[#F8F9FA] p-6 rounded-lg border border-gray-100">
              ...
              <div className="flex gap-2">
                {[1, 2, 3, 4, 5].map((star) => (
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className={`h-12 w-12 transition-colors duration-200 ${(hoverRating || rating) >= star ? 'text-[#E67E22]' : 'text-gray-300'}`} viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="mb-10">
              ...
              <p className="text-sm text-gray-500 mb-3">Tell us about a feature you'd like to see, or an issue you ran into.</p>
              <textarea required className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:border-[#C0392B] focus:ring-2 focus:ring-red-200 outline-none h-32 resize-none text-base transition-all shadow-inner" placeholder="E.g., I wish there was a way to filter parts by specific engine codes..."></textarea>
            </div>
